const translations = {
  ...
  en: { news: "News", ai_chat: "AI Chat", translate: "Translate", weather: "Weather", about: "About", terms: "Terms", privacy: "Privacy", settings_title: "Settings", lang_region: "Language & Region", appearance: "Appearance", light_theme: "Light Theme", dark_theme: "Dark Theme", save: "Save", saved: "✓ Settings saved!", back: "← Back", search_placeholder: "Search on Baobab...", ai_title: "✨ AI Summary by Baobab", about_title: "About Baobab Search", about_p1: "Welcome to Baobab Search.", terms_title: "Terms of Use", terms_p1: "1. Legal use only.", privacy_title: "Privacy Policy", privacy_p1: "Your privacy is important." },
  wo: { news: "Lëndëm", ai_chat: "AI Koor", translate: "Sopi Làkk", weather: "Weer", about: "Ci Baobab", terms: "Yoon yi", privacy: "Sutura", settings_title: "Jëfandikoo", lang_region: "Làkk ak Dëkku", appearance: "Nataal", light_theme: "Leer", dark_theme: "Guddi", save: "Denc", saved: "✓ Denc na!", back: "← Dellu", search_placeholder: "Laaj Baobab...", ai_title: "✨ Résumé AI", about_title: "Ci Baobab Search", about_p1: "Dalal ak jàmm ci Baobab Search.", terms_title: "Yoonu Jëfandikoo", terms_p1: "1. Jëf ci wàllu yoon.", privacy_title: "Sutura", privacy_p1: "Sutura la nu daj." }
};
...
function showPage(pageId) {
  // BUG FIX: On ne touche plus au menu ici
